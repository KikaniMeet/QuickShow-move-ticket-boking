...
const Dashboard = () => {
  ...
  const dashboardCards = [
    ...
    {
      title: "Total Revenue",
      value: `${currency} ${dashboardData.totalRevenue.toString()}`,
      ...
      <div className="relative flex flex-wrap gap-4 mt-6">
        ...
        <div className="flex flex-wrap gap-4 w-full">
          {dashboardCards.map((card, index) => (
            <div
              key={index}
              className="flex items-center justify-between px-4 py-3 bg-red-500/10 border border-red-500/20 rounded-md max-w-60 w-full"
            >
              <div>
