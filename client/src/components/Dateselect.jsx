...
const DateSelect = ({ dateTime, id }) => {
    ...
    return (
        <div id='dateSelect' className='pt-30'>
            <div className='flex flex-col md:flex-row items-center justify-between gap-10 relative p-8 bg-red-500/9 border border-red-500/20 rounded-lg'>
                                ...
                                <button
                                    ...
                                    className={`flex flex-col items-center justify-center h-14 w-14 rounded-lg transition cursor-pointer
                                        ${selected === date
                                            ...
                                            : "bg-gray-800 text-white hover:bg-primary border border-red-500/70"}
                                    `}
                                >
